...
namespace PhanMemQuanLyKhachSan
{
    public partial class frmManHinhChinh : Form
    {
        ...
        private void cmbPhong1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (trangThai)
            {
                ...
                case "Phòng Đang Dọn":
                    ...
                    break;
                case "Phòng Đã Đặt":
                    lblPhong1.BackColor = Color.Pink;
                    break;
            }
        }
        ...
        private void cmbPhong2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (trangThai)
            {
                ...
                case "Phòng Đang Dọn":
                    ...
                    break;
                case "Phòng Đã Đặt":
                    lblPhong2.BackColor = Color.Pink;
                    break;
            }
        }
        ...
        private void cmbPhong3_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (trangThai)
            {
                ...
                case "Phòng Đang Dọn":
                    ...
                    break;
                case "Phòng Đã Đặt":
                    lblPhong3.BackColor = Color.Pink;
                    break;
            }
        }
        ...
        private void cmbPhong4_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (trangThai)
            {
                ...
                case "Phòng Đang Dọn":
                    ...
                    break;
                case "Phòng Đã Đặt":
                    lblPhong4.BackColor = Color.Pink;
                    break;
            }
        }
        ...
        private void cmbPhong5_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (trangThai)
            {
                ...
                case "Phòng Đang Dọn":
                    ...
                    break;
                case "Phòng Đã Đặt":
                    lblPhong5.BackColor = Color.Pink;
                    break;
            }
        }
        ...
        private void cmbPhong6_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (trangThai)
            {
                ...
                case "Phòng Đang Dọn":
                    ...
                    break;
                case "Phòng Đã Đặt":
                    lblPhong6.BackColor = Color.Pink;
                    break;
            }
        }
        ...
        private void cmbPhong7_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (trangThai)
            {
                ...
                case "Phòng Đang Dọn":
                    ...
                    break;
                case "Phòng Đã Đặt":
                    lblPhong7.BackColor = Color.Pink;
                    break;
            }
        }
        ...
        private void cmbPhong8_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (trangThai)
            {
                ...
                case "Phòng Đang Dọn":
                    ...
                    break;
                case "Phòng Đã Đặt":
                    lblPhong8.BackColor = Color.Pink;
                    break;
            }
        }
        ...
        private void lblPhong4_Click(object sender, EventArgs e)
        {
            Application.Exit();
        }
